...
@router.get("/words/{word_id}", response_model=WordPublic, response_model_exclude_none=True)
async def get_word_details(word_id: int, session: Session = Depends(get_session)) -> Word:
