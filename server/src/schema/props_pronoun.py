...
class PronounPropsBaseSchema(BaseModel):
    declination_type: Optional[DeclinationType]
    pronoun_type: Optional[PronounType]
...
class PronounPropsCreateSchema(PronounPropsBaseSchema):
    props_type: Literal["pronoun"]
